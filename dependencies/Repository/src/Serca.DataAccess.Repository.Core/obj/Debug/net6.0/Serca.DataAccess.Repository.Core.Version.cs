...
internal static partial class ThisAssembly {
    ...
    internal const string AssemblyName = "Serca.DataAccess.Repository.Core";
    internal const string AssemblyTitle = "Serca.DataAccess.Repository.Core";
    internal const string AssemblyVersion = "0.0.0.0";
    internal const bool IsPrerelease = false;
    internal const bool IsPublicRelease = false;
    internal const string RootNamespace = "Serca.DataAccess.Repository.Core";
}
